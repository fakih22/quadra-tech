...
export default function About() {
  return (
    <section className="py-16 md:py-32 bg-white" id="tentang">
      <div className="w-full max-w-[1280px] mx-auto px-5 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
          {/* About Image */}
          <div className="relative">
            <div className="w-full aspect-[5/4] bg-gray-900 overflow-hidden relative">
              <img 
            ...
            <div className="md:absolute relative md:bottom-[-24px] md:right-[-24px] w-full md:w-[200px] bg-red-600 p-8 text-white mt-6 md:mt-0">
