...
export default function Team() {
  ...
  return (
    <ScrollReveal className="py-16 md:py-32 bg-gray-50 border-t border-gray-200" id="tim" direction="none">
      <div className="w-full max-w-[1280px] mx-auto px-5 md:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, index) => (
            ...
            >
              <div 
                className="bg-white border border-gray-200 overflow-hidden transition-all duration-300 group hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 h-full rounded-xl"
              >
                <div className="w-full aspect-square bg-gray-200 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 flex gap-0 translate-y-full transition-transform duration-300 group-hover:translate-y-0 z-10">
                ...
                <div className="p-6 relative z-10 bg-white">
                  <h3 className="text-base font-bold tracking-[-0.3px] mb-1 group-hover:text-red-600 transition-colors duration-300">{member.name}</h3>
